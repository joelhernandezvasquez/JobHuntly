...
const Input = ({ id, name, variant, placeholder, defaultValue, errorMessage, isInvalid, onValuedChange, iconSearch }: Props) => {
  ...
  return (
     ...
     <div className={style.input_container} 
      ...
      <div data-testid="input-component-test" className={`${style.input_container_field} ${isInvalid && style.input_container_field_error_state} ${iconSearch && style.add_padding}`}>
