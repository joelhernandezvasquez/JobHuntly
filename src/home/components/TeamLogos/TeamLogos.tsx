    ...
    return (
        <div className={style.team_logo_wrapper}>
            ...
            <ul className={style.team_logo_menu}>
                {teamLogos.map((team) => {
                    return (
                        <li role='listitem' key={team.id} className={style.team_logo_menu_item}>
                            <Image
                                src={team.logo}
                                width={42}
                                height={42}
